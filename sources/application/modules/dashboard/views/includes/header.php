...
<?php if(isset($shortcutIcon)): ?><!-- BEGIN SHORTCUT ICON -->
{shortcutIcon}
<!-- END SHORTCUT ICON --><?php echo PHP_EOL; endif;  ?>
<?php if(isset($touchIcon)): ?><!-- BEGIN TOUCH ICON -->
{touchIcon}
<!-- END TOUCH ICON --><?php echo PHP_EOL; endif; ?>
