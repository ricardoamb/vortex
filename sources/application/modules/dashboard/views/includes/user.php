                ...
                <ul class="list-material message-list">
                    ...
                    <li class="has-action-left has-action-right">
                        <a href="#" class="visible" data-message-id="2">
                            <div class="list-action-left">
                                <img src="<?php echo base_url('assets/img/faces'); ?>/10.jpg" class="face-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left has-action-right">
                        <a href="#" class="visible" data-message-id="3">
                            <div class="list-action-left">
                                <img src="<?php echo base_url('assets/img/faces'); ?>/11.jpg" class="face-radius" alt="">
                            </div>
                            <div class="list-content">
                    ...
                    <li class="has-action-left has-action-right">
                        <a href="#" class="visible" data-message-id="2">
                            <div class="list-action-left">
                                <img src="<?php echo base_url('assets/img/faces'); ?>/16.jpg" class="face-radius" alt="">
                            </div>
                            <div class="list-content">
                ...
                <div class="message-send-container">
                    ...
                    <div class="messages">
                        <div class="message left">
                            ...
                            <img src="<?php echo base_url('assets/img/faces'); ?>/1.jpg" class="user-picture" alt="">
                        </div>
                        <div class="message right">
                            ...
                            <img src="<?php echo base_url('assets/img/faces'); ?>/tolga-ergin.jpg" class="user-picture" alt="">
                        </div>
                        <div class="message left">
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <ul class="list-material has-hidden">
                    ...
                    <li class="has-action-left has-action-right has-long-story">
                        ...
                        <a href="#" class="visible">
                            <div class="list-action-left">
                                <img src="<?php echo base_url('assets/img/faces'); ?>/14.jpg" class="face-radius" alt="">
                            </div>
                            <div class="list-content">
